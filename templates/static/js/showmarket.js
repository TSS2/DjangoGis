$(document).ready(function(){
  ...
  // heatmap('heatmap')
    ...
    // heatmap('map')
    // heatmap('map')
    var heatmaps = new ol.layer.Heatmap({
     ...
     $('#district2').bind("change",function(){  
        ...
        $.each(data,function(index,value){
          ...
          $("#"+id).bind({
            ...
            mouseenter:function(){      // 鼠标移动到点上时显示信息
              id_n = id + '1'
              $('#'+id).append("<div id = "+id_n+" class = 'popup-content list-group'><ul class='list-group'><li id='li_name' class='list-group-item'><span class='label label-default'>Default</span>插入项</li><li id='li_address' class='list-group-item'>插入项</li></ul></div>");
              // $('#'+id_n).text(add_name);
          ...
          $('#'+id).on('click', function(){
            layer.open({
              ...
              content: "/mygis/marketmessage/?name="+add_name
            });
          });
      ...
      // ====================================================================//
      // 基于社区
      $('#market_com').click(function(){
        // var market_com = $('#market_com').text()
